...
final sampleDkshBillModel = DkshBillModel(
  ...
  totalMoneyByLetters:
      'หนึ่งล้านหนึ่งแสนหนึ่งหมื่นสี่พันหนึ่งร้อยเจ็ดสิบเก้าบาทแปดสิบเจ็ดสตางค์',
  netSalesAfterVAT: '1,114,179.87',
  netSalesBeforeVAT: '1,114,179.87',
  percentVAT: '7.00',
...
final sampleDdcBillModel = DdcReportModel(
  ...
  customerPriceList: <CustomerPriceModel>[
    CustomerPriceModel(
      ...
      date: '070223 12:12',
      customerId: 'A700743',
      customerName: 'abcdefghijklmnp',
      smCode: "1195",
      price: '1,336,147.00',
      diValue: '1,477.70',
      doValue: '0.00',
      netAmount: '3,024,669.30',
      tax: '130,726.85',
      total: '3,426,396.15',
      st: 'C',
      l: '13993',
...
final sampleCclrBillModel = CclrReportModel(
  ...
  callingList: <CallingModel>[
    CallingModel(
      ...
      reason: '13 รอตัดสินใจ/รอเช็คสต็อก',
